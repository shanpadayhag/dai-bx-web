/**
 * Timer types ported 1:1 from client-web-old/.../timers/data-access/timers.types.ts.
 * Includes the `ActiveRun` discriminated union persisted to localStorage and the
 * defensive type guards used when hydrating it.
 */
